...
public class Home_TC {
    ...
    private final String InExP_product_Details = DataUtitlie.getPropertyValue("enviroments","Product_Details_URL");
    private final String Expected= DataUtitlie.getPropertyValue("enviroments","Valid_Product_Details_URL");
    private final String Cart = DataUtitlie.getPropertyValue("enviroments","Cart_Link");
    public Home_TC() throws IOException {
    }
    @BeforeMethod
